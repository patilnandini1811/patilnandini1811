...
## 🚀 About Me
I’m a Junior Fullstack Developer with a strong focus on frontend development and hands-on experience building web and mobile applications using React, TypeScript, and cloud technologies.  
I enjoy creating clean user interfaces, working with APIs, and contributing to real projects through code reviews, pull requests, and feature development.
...
- Built and maintained frontend features using **React Native & TypeScript**
- Integrated AWS services (**Lambda, API Gateway, Cognito, DynamoDB, S3**)
- Submitted **pull requests, reviewed code, and contributed to production features**
- Improved UI, user flows, and API integrations across the application
...
![Languages and Tools](assets/tools.png)
